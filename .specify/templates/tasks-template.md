...
**Tests**: Include test tasks whenever the feature changes user-visible behavior,
tool contracts, parsing, extraction, or compatibility guarantees. Omit tests only
for strictly non-behavioral work such as documentation-only changes.
